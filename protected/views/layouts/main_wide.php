...
<div id="ariext88_container" class="ux-menu-container ux-menu-clearfix">
	...
	<ul id="ariext88" class="ux-menu ux-menu-horizontal">
		<li class="ux-menu-item-main ux-menu-item-level-0 ux-menu-item470 ux-menu-item-parent ux-menu-item-parent-pos0">
				<a href="http://elvispiter.ru/index.php" class=" ux-menu-link-level-0 ux-menu-link-first" title="">
					На главную									</a>
	...
	<ul class="ux-menu-sub ux-menu-init-hidden">
				...
				<a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=regions" class=" ux-menu-link-level-1" title="">
					Щиты 3*6									</a>
				<div class="left-circ-2"></div>
				<div class="left-circ"></div>
						</li>
		...
		<li class="ux-menu-item-main ux-menu-item-level-0 ux-menu-item471 ux-menu-item-parent-pos1" style="width:540px">
					<span id="sel_screen"></span>			
				<div class="left-circ-2" style="left:460px"></div>
				<div class="left-circ" style="left:460px"></div>
			
			</li>	
		<li class="ux-menu-item-main ux-menu-item-level-0 ux-menu-item473 ux-menu-item-parent-pos2" style="margin-left:30px">
				<a href="javascript:void(0)" id="pickbutton" onclick="gogo()" class=" ux-menu-link-level-0 ux-menu-link-parent" title="">
					Выбрать										<span class="ux-menu-arrow"></span>
									</a>
				<div class="left-circ-2"></div>
				<div class="left-circ"></div>
